...
InputDecoration buildInputDecoration(String name) {
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8.0), borderSide: const BorderSide(color: viewLineColor, width: 0.5)),
    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8.0), borderSide: const BorderSide(color: viewLineColor, width: 0.5)),
  );
}
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(Icons.chevron_left_outlined, color: mpAppButtonColor, size: 25).onTap(() {
                ...
                16.width,
                const Icon(Icons.keyboard_arrow_right, color: mpAppButtonColor, size: 25).onTap(() {
...
class EditProfileSwitchWidget extends StatefulWidget {
  ...
  EditProfileSwitchWidget({super.key, this.name, this.isSelected = true});
