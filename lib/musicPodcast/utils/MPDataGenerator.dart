...
import 'package:study_app/musicPodcast/screen/Lipsum.dart' as lipsum;

List<DrawerList> getDrawerList() {
  List<DrawerList> drawerList = [];
  drawerList.add(DrawerList(name: "Semester 1", widget: MPProfileScreen(isTab: true)));
  drawerList.add(DrawerList(name: "Semester 2", widget: const MPSongsScreen()));
  drawerList.add(DrawerList(name: "Semester 3", widget: const MPArtistsScreen(name: 'Artists')));
  drawerList.add(DrawerList(name: "Semester 4", widget: MPAlbumsScreen(isTab: false)));
  drawerList.add(DrawerList(name: "Semester 5", widget: const MPPodCastScreen(name: 'Podcasts')));
  drawerList.add(DrawerList(name: "Semester 6", widget: const MPNewsScreen(name: 'News')));
  drawerList.add(DrawerList(name: "Events", widget: const MPEventsScreen(name: 'Events')));
  drawerList.add(DrawerList(name: "Playlist", widget: const MPPlayListScreen()));
  drawerList.add(DrawerList(name: "Setting", widget: const MPSettingScreen()));
