...
class MPPlayListDetailScreen extends StatefulWidget {
  ...
  const MPPlayListDetailScreen({super.key, this.data});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Row(
                              children: [
                                const Icon(Icons.access_time, color: white, size: 18),
                                12.width,
            ...
            Row(
              children: [
                const Icon(Icons.play_circle_outline, color: mpAppButtonColor, size: 24),
                16.width,
