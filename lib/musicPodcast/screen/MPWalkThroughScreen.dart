...
class MPWalkThroughScreen extends StatefulWidget {
  ...
  const MPWalkThroughScreen({super.key});
          ...
          children: [
            ...
            Positioned(
              ...
              child: DotIndicator(
                ...
                onDotTap: (s) {
                  pageController.animateToPage(s, duration: const Duration(milliseconds: 5), curve: Curves.bounceIn);
                },
              ),
            ),
            Align(
              ...
              child: AppButton(
                ...
                onTap: () {
                  pageController.nextPage(duration: const Duration(milliseconds: 500), curve: _kCurve);

                  if (currentPage == 2) {
                    const MPSignInAndSignUpScreen().launch(context);
                  }
                },
